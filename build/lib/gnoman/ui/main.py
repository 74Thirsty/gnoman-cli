"""Textual mission-control interface for GNOMAN."""
...
class NetworkMetrics:
    """Snapshot of live Ethereum network telemetry."""
...
def get_web3_client() -> Web3:
    """Return a cached :class:`~web3.Web3` connected to the configured RPC."""
...
def fetch_network_metrics() -> NetworkMetrics:
    """Collect network metrics from the configured RPC endpoint."""
...
__all__ = ["GNOMANMain", "fetch_network_metrics", "get_web3_client", "NetworkMetrics"]
